...
def get_category_urls(shopee_url='https://shopee.sg/'):
    from selenium import webdriver
    from selenium.webdriver.common.by import By
    from webdriver_manager.chrome import ChromeDriverManager

    driver = webdriver.Chrome(ChromeDriverManager().install()) #luanch chrome
    driver.get(shopee_url) 

    elements = driver.find_elements(By.CLASS_NAME, "home-category-list__category-grid")
